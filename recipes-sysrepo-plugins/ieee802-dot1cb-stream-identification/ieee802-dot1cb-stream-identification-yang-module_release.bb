...
do_install() {
    ...
    # yang modules
    install -m 0644 ${S}/${sysconfdir}/netopeer2/yang/ieee802-dot1cb-stream-identification-types.yang ${D}/${sysconfdir}/netopeer2/yang
    install -m 0644 ${S}/${sysconfdir}/netopeer2/yang/ieee802-dot1cb-stream-identification.yang ${D}/${sysconfdir}/netopeer2/yang

    # library
    install -m 0644 ${S}/${libdir}/sysrepo/plugins/libieee802-dot1cb-stream-identification-yang-module.so ${D}/${libdir}/sysrepo/plugins/
