...
do_install() {
    ...
    install -m 0644 ${S}/${sysconfdir}/netopeer2/yang/ieee8021-mstp.yang ${D}/${sysconfdir}/netopeer2/yang

    install -m 0644 ${S}/${libdir}/sysrepo/plugins/libieee8021-mstp.so ${D}/${libdir}/sysrepo/plugins/
