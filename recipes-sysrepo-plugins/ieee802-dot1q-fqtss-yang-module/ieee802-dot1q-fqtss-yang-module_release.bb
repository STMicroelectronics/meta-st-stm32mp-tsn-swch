...
do_install:append () {
    ...
    cp -r ${S}/../YANG_modules_repository/ieee802-dot1q-fqtss.yang ${D}/etc/netopeer2/yang
    ...
    patchelf --replace-needed libbase.so libbase.so.1 ${D}${libdir}/sysrepo/plugins/libieee802-dot1q-fqtss.so
    patchelf --replace-needed libtsn.so libtsn.so.2 ${D}${libdir}/sysrepo/plugins/libieee802-dot1q-fqtss.so
}
