...
do_install() {
    ...
    # yang modules
    install -m 0644 ${S}/${sysconfdir}/netopeer2/yang/ieee802-dot1q-fqtss.yang ${D}/${sysconfdir}/netopeer2/yang
    install -m 0644 ${S}/${sysconfdir}/netopeer2/yang/ietf-yang-smiv2.yang ${D}/${sysconfdir}/netopeer2/yang
    install -m 0644 ${S}/${sysconfdir}/netopeer2/yang/ietf-yang-types.yang ${D}/${sysconfdir}/netopeer2/yang
    install -m 0644 ${S}/${sysconfdir}/netopeer2/yang/SNMPv2-TC.yang ${D}/${sysconfdir}/netopeer2/yang

    # library
    install -m 0644 ${S}/${libdir}/sysrepo/plugins/libieee802-dot1q-fqtss.so ${D}/${libdir}/sysrepo/plugins/
