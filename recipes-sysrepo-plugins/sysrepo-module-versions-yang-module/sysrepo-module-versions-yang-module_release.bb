...
do_install:append () {
    ...
    cp -r ${S}/../YANG_modules_repository/sysrepo-module-versions.yang ${D}/etc/netopeer2/yang
    cp -r ${S}/sysrepo-module-versions.data.xml ${D}/etc/netopeer2/yang
    ...
    patchelf --replace-needed libbase.so libbase.so.1 ${D}${libdir}/sysrepo/plugins/libsysrepo-module-versions.so
}
